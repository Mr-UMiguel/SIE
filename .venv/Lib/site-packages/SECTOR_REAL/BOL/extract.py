...
@task(name="BOL-1_01_1",log_stdout=True, max_retries=2,retry_delay=datetime.timedelta(seconds=2))
...
@task(name="BOL-1_11_1",log_stdout=True, max_retries=2,retry_delay=datetime.timedelta(seconds=2))
...
@task(name="BOL-1_17_1",log_stdout=True, max_retries=2,retry_delay=datetime.timedelta(seconds=2))
